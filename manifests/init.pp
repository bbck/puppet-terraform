...
class terraform(
  ...
  case $ensure {
    present: {
      ...
      $download_uri = "https://releases.hashicorp.com/terraform/${version}/terraform_${version}_${terraform::params::_real_platform}.zip"
      ...
      $install_command = join([
        ...
        "curl ${download_uri} > /tmp/terraform-v${version}.zip",
